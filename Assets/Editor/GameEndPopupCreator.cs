...
public static class GameEndPopupCreator
{
    ...
    public static void SetupGameEndPopup()
    {
        ...
        // ── 5c. Trophy Icon / Header ──
        Color pinkText = new Color(0.96f, 0.2f, 0.5f);
        AddTMPText(innerPanelGo, "Header", new Vector2(0f, -40f), new Vector2(700f, 80f), 
            "🏆 TAMAT! 🏆", 60f, FontStyles.Bold, pinkText, new Vector2(0.5f, 1f), new Vector2(0.5f, 1f), new Vector2(0.5f, 1f));

        // ── 5d. Congrats text ──
        Color brownText = new Color(0.45f, 0.30f, 0.15f);
        AddTMPText(innerPanelGo, "CongratsText", new Vector2(0f, -120f), new Vector2(700f, 60f), 
            "Tahniah! Anda telah mencapai petak akhir!", 
            32f, FontStyles.Bold, brownText, new Vector2(0.5f, 1f), new Vector2(0.5f, 1f), new Vector2(0.5f, 1f));

        // ── 5e. Score display ──
        var scoreGo = AddTMPText(innerPanelGo, "ScoreText", new Vector2(0f, 20f), new Vector2(700f, 80f), 
            "Jumlah Markah: 0", 
            48f, FontStyles.Bold, pinkText, new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f));

        // ── 5f. Stars display ──
        Color starColor = new Color(1.0f, 0.8f, 0.1f);
        var starsGo = AddTMPText(innerPanelGo, "StarsText", new Vector2(0f, -60f), new Vector2(700f, 60f), 
            "★ ★ ★", 
            50f, FontStyles.Bold, starColor, new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f));
